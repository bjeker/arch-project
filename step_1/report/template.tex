...
\title{Building an Integer ALU \\ CS 3339 \\ Group: The Architects} % Report title
...
To introduce the process and methodology of deigning a new computer circuit from scratch by coding 1-bit circuits for Not, Nand, Nor, and 4-bit Shift.
